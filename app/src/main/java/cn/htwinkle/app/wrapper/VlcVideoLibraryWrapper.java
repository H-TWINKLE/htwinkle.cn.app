 ...
 */
public class VlcVideoLibraryWrapper implements MediaPlayer.EventListener {
  ...
  public VlcVideoLibraryWrapper(Context context, VlcListener vlcListener, SurfaceView surfaceView) {
  ...
  public VlcVideoLibraryWrapper(Context context, VlcListener vlcListener, SurfaceView surfaceView, int width,
                                int height) {
    this.vlcListener = vlcListener;
    this.surfaceView = surfaceView;
    vlcInstance = new LibVLC(context, new VlcOptions().getDefaultOptions());
  ...
  public VlcVideoLibraryWrapper(Context context, VlcListener vlcListener, TextureView textureView) {
    this.vlcListener = vlcListener;
  ...
  public VlcVideoLibraryWrapper(Context context, VlcListener vlcListener, SurfaceTexture surfaceTexture) {
    this.vlcListener = vlcListener;
  ...
  public VlcVideoLibraryWrapper(Context context, VlcListener vlcListener, Surface surface) {
    this.vlcListener = vlcListener;
  ...
  public VlcVideoLibraryWrapper(Context context, VlcListener vlcListener, Surface surface, int width,
                                int height) {
    this.vlcListener = vlcListener;
    this.surface = surface;
    this.width = width;
